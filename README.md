...
disciplina de las ciencias de la computación que se encarga de la generación, manipulación y almacenamiento de imágenes y objetos geométricos mediante algoritmos digitales.

1-que es Historia y evolución de la graficación por computadora

el arte y la ciencia de generar, manipular y visualizar imágenes mediante software y hardware, evolucionando desde simples líneas en osciloscopios de los años 50 hasta el fotorrealismo 3D y realidad virtual actuales
...
Pero para entender cómo es que la graficación ha llegado a ser una rama tan fascinante es necesario hacer un breve recorrido a través del tiempo presentando su origen, desarrollo histórico hasta llegar al auge que se vive hoy en día.
...
Evolución Clave de la Graficación por Computadora:
...
<img width="840" height="676" alt="image" src="https://github.com/user-attachments/assets/3d58e8e0-83e4-48d1-8854-d5dcb72f0018" />
...
<img width="941" height="401" alt="image" src="https://github.com/user-attachments/assets/0611615d-ce43-457f-a86f-33706bdfec6a" />
...
4- Modelos del color: RBG, CMY, HSV y HSL.
...
<img width="344" height="327" alt="image" src="https://github.com/user-attachments/assets/064f1df9-9a8a-402c-96ef-ec176dbb627a" />
...
<img width="359" height="247" alt="image" src="https://github.com/user-attachments/assets/f4287a71-7b90-45f3-8533-e17bee2c5c02" />
...
<img width="359" height="259" alt="image" src="https://github.com/user-attachments/assets/8ef85a4c-9776-4f71-9f31-c58d31001038" />
...
<img width="484" height="57" alt="image" src="https://github.com/user-attachments/assets/0250a2cc-4bf3-443c-a5c4-4bdf97bf9139" />
...
<img width="388" height="227" alt="image" src="https://github.com/user-attachments/assets/697065f8-00ca-492e-9bfa-b3346509536f" />
...
<img width="428" height="276" alt="image" src="https://github.com/user-attachments/assets/38d9f225-6ff8-4795-ad6d-4c6b752a2a2e" />
...
•	· Apple Mac OS X system color picker (disco de color para H/S y un deslizador para V).  •	· The GIMP2 
...
•	· La especificación CSS3  •	· Facebook api web Developer  •	· Inkscape (desde la versión 0.42) •	· Macromedia Studio 


•	· Microsoft Windows system color picker (y MSPaint) •	· Paint Shop Pro 


3-Aplicaciones que utilizan HSV y HSL: 


•	· Las aplicaciones gráficas de Adobe (Illustrator, Photoshop, y otros) •	· Pixel image editor (desde la Beta5) 
...
Se eliminan todos los objetos existentes para comenzar con una escena completamente limpia. 


Esto garantiza que no haya elementos que interfieran con la práctica. 
...
•	Se activa Cycles, el motor de render físicamente realista. •	Se configuran 128 muestras para mejorar la calidad de sombras e iluminación. 


Esto permite observar correctamente cómo la luz interactúa con las superficies del cubo. 


Creación del Cubo (Representación de Polígonos 3D) 


bpy.ops.mesh.primitive_cube_add(size=2, location=(0, 0, 0)) 


4-El cubo es un objeto compuesto por: 


•	8 vértices •	12 aristas •	6 caras (polígonos cuadrados) 


Aquí se demuestra cómo los objetos 3D están formados por polígonos planos. 


Asignación de Materiales 


Se crea un material base usando el nodo Principled BSDF, que simula el comportamiento físico de la luz.


5-Se modifican: 


•	Base Color: Color del objeto •	Metallic: Nivel metálico •	Roughness: Nivel de brillo 


Luego, cada cara del cubo recibe un material distinto, lo que permite visualizar cómo la luz afecta cada superficie de manera independiente. 


Esto demuestra el concepto de iluminación por cara. 


Iluminación 


6-Se agregan dos tipos de luces: 


Luz SUN 

 
Simula luz solar direccional. 
...
Suaviza sombras y mejora el contraste. 

7-Esto permite observar: 


•	Sombras proyectadas •	Interacción luz-superficie •	Variación de intensidad según orientación de la cara 
Cámara 
...
8-Se posiciona estratégicamente para: 


•	Enfocar el cubo •	Incluir el polígono y la Flor de la Vida •	Permitir una visualización tridimensional adecuada 
...
9-Se crea un hexágono configurando: 


•	6 vértices •	Tipo NGON (cara cerrada) 


Esto demuestra la construcción de un polígono regular en 2D dentro del entorno 3D.


Generación de la Flor de la Vida 


Se utiliza un doble bucle for para repetir círculos con el mismo radio, desplazándolos en un patrón geométrico.


10-Matemáticamente se utilizan: 


•	√3 para desplazamiento horizontal •	1.5 × radio para desplazamiento vertical 


11-Esto genera un patrón simétrico basado en repetición y coordenadas espaciales. 
Aquí se aplica: 


•	Representación de curvas •	Transformaciones espaciales •	Simetría geométrica Animación 


12-Se insertan keyframes: 


•	Frame 1 : Rotación inicial •	Frame 120 :  Rotación de 360° 


Se aplica interpolación lineal para mantener velocidad constante. 
Esto demuestra: 


•	Transformaciones geométricas •	Movimiento en espacio 3D •	Uso del eje X e Y 

<img width="941" height="529" alt="image" src="https://github.com/user-attachments/assets/e55bb513-f096-4c1c-b167-9038263875ba" />


<img width="941" height="529" alt="image" src="https://github.com/user-attachments/assets/5826d53d-6896-4caa-8023-f80513da17be" />


<img width="941" height="529" alt="image" src="https://github.com/user-attachments/assets/485efbaf-f5e1-4a98-ae7b-a6dfb6b51ee3" />
...
Martinez, M. (s. f.). Áreas de aplicación de la Graficacion por computadora. https://marcosdejesusmartinezmendez1.blogspot.com/2017/08/areas-de-aplicacion-de-la-graficacion.html 
